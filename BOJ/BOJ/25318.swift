...
// 1: o, 2: t, 3: th, 4: f, 5: fi, 6: si, 7: s, 8: e, 9: n, 10: te
import Foundation


class tfithoe{
    
    private var opi_num: Int
    private var T: [String] = []
    private var L: [Int] = []
    private var dp_p: [Double] = []
    private var dp_pl: [Double] = []
    private var sum_p: Double = 0
    private var sum_pl: Double = 0
    
    private var res: Double = 0
